//
//  XishaSearchTestReportViewController.m
//  lanhailieren
//
...
@interface XishaSearchTestReportViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UserModule_HotSearchProtocol,UserModule_GetSearchKeyWordListProtocol,UserModule_CleanSearchKeyWordProtocol,UserModule_AddSearchKeyWordProtocol>
...
@implementation XishaSearchTestReportViewController
...
- (void)pushFoodListVCWithCategoryID:(int)categoryId andPlate:(int )plate andIs_hot:(int)isHot andIs_red:(int)isred
{
    ...
    TestReportSearchResultViewController * vc = [[TestReportSearchResultViewController alloc]init];
