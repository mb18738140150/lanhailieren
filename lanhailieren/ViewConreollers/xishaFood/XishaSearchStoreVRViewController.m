//
//  XishaSearchStoreVRViewController.m
//  lanhailieren
//
...
@interface XishaSearchStoreVRViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UserModule_HotSearchProtocol,UserModule_GetSearchKeyWordListProtocol,UserModule_CleanSearchKeyWordProtocol,UserModule_AddSearchKeyWordProtocol>
...
@implementation XishaSearchStoreVRViewController
...
{
    self.navigationItem.title = @"门店VR列表";
...
- (void)pushFoodListVCWithCategoryID:(int)categoryId andPlate:(int )plate andIs_hot:(int)isHot andIs_red:(int)isred
{
    ...
    XishaSearchStoreVRResultViewController * vc = [[XishaSearchStoreVRResultViewController alloc]init];
