//
//  StoreGoodFoodSearchViewController.m
//  lanhailieren
//
...
@interface StoreGoodFoodSearchViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UserModule_HotSearchProtocol,UserModule_GetSearchKeyWordListProtocol,UserModule_CleanSearchKeyWordProtocol,UserModule_AddSearchKeyWordProtocol>
...
@implementation StoreGoodFoodSearchViewController
...
- (void)pushFoodListVCWithCategoryID:(int)categoryId andPlate:(int )plate andIs_hot:(int)isHot andIs_red:(int)isred
{
    ...
    StoreGoodFoodSearchResultViewController * vc = [[StoreGoodFoodSearchResultViewController alloc]init];
