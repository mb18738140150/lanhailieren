...
@interface SearchEntertainmentViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UserModule_HotSearchProtocol,UserModule_GetSearchKeyWordListProtocol,UserModule_CleanSearchKeyWordProtocol,UserModule_AddSearchKeyWordProtocol>
...
- (void)pushFoodListVCWithCategoryID:(int)categoryId andPlate:(int )plate andIs_hot:(int)isHot andIs_red:(int)isred
{
    ...
    SearchEntertainmentResultViewController * vc = [[SearchEntertainmentResultViewController alloc]init];
    vc.key = self.currentKey;
    vc.channelName = @"arder";
