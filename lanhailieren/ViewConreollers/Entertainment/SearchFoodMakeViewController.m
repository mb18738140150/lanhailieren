//
//  SearchFoodMakeViewController.m
//  lanhailieren
//
...
#import "SearchFoodMakeResultViewController.h"

@interface SearchFoodMakeViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UserModule_HotSearchProtocol,UserModule_GetSearchKeyWordListProtocol,UserModule_CleanSearchKeyWordProtocol,UserModule_AddSearchKeyWordProtocol>
...
@implementation SearchFoodMakeViewController
...
- (void)pushFoodListVCWithCategoryID:(int)categoryId andPlate:(int )plate andIs_hot:(int)isHot andIs_red:(int)isred
{
    ...
    SearchFoodMakeResultViewController * vc = [[SearchFoodMakeResultViewController alloc]init];
