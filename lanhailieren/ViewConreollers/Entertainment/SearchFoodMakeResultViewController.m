//
//  SearchFoodMakeResultViewController.m
//  lanhailieren
//
...
@interface SearchFoodMakeResultViewController ()<UserModule_ChannelListProtocol,UserModule_GoodProtocol,UserModule_CollectProtocol,UICollectionViewDelegate,UICollectionViewDataSource,UserModule_VIPCustomProtocol,UICollectionViewDelegateFlowLayout>
...
@implementation SearchFoodMakeResultViewController
...
- (UICollectionView *)tableView{
    if (_tableView == nil) {
        ...
        }else
        {
            ...
            layout.itemSize = CGSizeMake(kScreenWidth, imageWidth * 0.41 + 50);
        }
