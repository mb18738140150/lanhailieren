...
-(void)btnAction:(UIButton *)sender{
    ...
    NSString * tipStr = [NSString stringWithFormat:@"点击：%@",self.titleArr[sender.tag]] ;
    
    if (self.shareBolck) {
        self.shareBolck(@{@"tag":@(sender.tag)});
    }
    
//    [ToolTipView showMessage:tipStr offset:-15];
}
