//
//  ClubSearchRecommendViewController.m
//  lanhailieren
//
...
@interface ClubSearchRecommendViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UserModule_HotSearchProtocol,UserModule_GetSearchKeyWordListProtocol,UserModule_CleanSearchKeyWordProtocol,UserModule_AddSearchKeyWordProtocol>
...
@implementation ClubSearchRecommendViewController
...
- (void)pushFoodListVCWithCategoryID:(int)categoryId andPlate:(int )plate andIs_hot:(int)isHot andIs_red:(int)isred
{
    ...
    ClubActivitySearchResultViewController * vc = [[ClubActivitySearchResultViewController alloc]init];
