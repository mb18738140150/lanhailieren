//
//  ClubContestSearchResultViewController.m
//  lanhailieren
//
...
#import "ClubContestSearchResultViewController.h"
...
@interface ClubContestSearchResultViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UserModule_ChannelListProtocol,UserModule_ChannelDetailProtocol>
...
@implementation ClubContestSearchResultViewController
...
{
    [SVProgressHUD show];
    [[UserManager sharedManager] didRequestClubContextListWithInfo:@{@"command":@30,@"channel_name":@"game",@"category_id":@0,@"page_size":@(self.page_size),@"page_index":@(self.page_index),@"key":self.key,@"sort":@(self.sort),@"is_red":@0} withNotifiedObject:self];
}

- (void)loadData
{
    [SVProgressHUD show];
    [[UserManager sharedManager] didRequestClubContextListWithInfo:@{@"command":@30,@"channel_name":@"game",@"category_id":@0,@"page_size":@(self.page_size),@"page_index":@(self.page_index),@"key":self.key,@"sort":@"0",@"is_red":@0} withNotifiedObject:self];
}
