//
//  ClubSearchContestViewController.m
//  lanhailieren
//
...
@interface ClubSearchContestViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UserModule_HotSearchProtocol,UserModule_GetSearchKeyWordListProtocol,UserModule_CleanSearchKeyWordProtocol,UserModule_AddSearchKeyWordProtocol>
...
@implementation ClubSearchContestViewController
...
{
    self.navigationItem.title = @"俱乐部比赛";
...
- (void)pushFoodListVCWithCategoryID:(int)categoryId andPlate:(int )plate andIs_hot:(int)isHot andIs_red:(int)isred
{
    ...
    ClubContestSearchResultViewController * vc = [[ClubContestSearchResultViewController alloc]init];
