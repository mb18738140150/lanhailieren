...
@interface YAddressPickerView()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation YAddressPickerView
...
- (void)completeOnClick:(id)sender{
    ...
    NSLog(@"   %@     %@     %@",p.province,c.city,c.areaListArray[areaIndex]);
}
